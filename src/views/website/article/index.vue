  ...
  <div>
    <card v-show="isShow">
      <div slot="header">
        ...
        <el-select v-model="searchType" placeholder="搜索文章类型" clearable @change="getArticle">
          <el-option
        ...
        <el-button type="success" class="el-icon-search" @click="getArticle">搜索</el-button>
    ...
    <article-detail v-show="!isShow" ref="ArticleDetail" @tab="tab" @update="getArticle"></article-detail>
  </div>
</template>
